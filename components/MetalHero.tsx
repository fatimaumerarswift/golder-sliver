    ...
    <>
      ...
      <div className="bg-white py-6 px-4">
       <div className="relative overflow-hidden w-full rounded-xl h-[260px] sm:h-[320px] md:h-[380px] lg:h-[450px]">
                ...
                Learn how valuable precious metals are recovered from electronics, silverware, and industrial
scrap through modern recycling method
                   </p>
                 </div>
               </div>
      </div>
